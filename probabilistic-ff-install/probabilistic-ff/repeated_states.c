 ...
 */
static EhcHashEntry_pointer lehc_hash_entry[EHC_HASH_SIZE];
extern int lnum_ehc_hash_entry[EHC_HASH_SIZE];
extern int lchanged_ehc_entrys[EHC_HASH_SIZE];
extern int lnum_changed_ehc_entrys;
static Bool lchanged_ehc_entry[EHC_HASH_SIZE];
 ...
 */
static BfsHashEntry_pointer lbfs_hash_entry[BFS_HASH_SIZE];
